...
export interface ColumnDef<T = any> {
	...
	editor?: (params: { value: any; row: T; onChange: (next: any) => void; stopEditing: (commit: boolean) => void; }) => React.ReactNode;
}
...
export interface DataGridProps<T = any> {
	...
	// editing
	onCellEdit?: (args: { rowId: string | number; columnKey: string; value: any; row: T }) => void;
